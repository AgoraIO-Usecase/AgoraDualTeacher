...
/**
 ...
 agora::rtm::IRtmService::sendMessageToPeer(const char *peerId, const IMessage
 *message, const SendMessageOptions &options) "sendMessageToPeer" method to be
 compatible with the endCall method of the legacy Agora Signaling SDK.
 */
...
enum LOGIN_ERR_CODE {
  ...
  /**
   8: The user has already logged in or is logging in the Agora RTM system, or
   the user has not called the \ref agora::rtm::IRtmService::logout "logout"
   method to leave the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
   */
  LOGIN_ERR_ALREADY_LOGGED_IN = 8,

  /**
   9: The login times out. The current timeout is set as six seconds. You need
   to log in again.
   */
  LOGIN_ERR_TIMEOUT = 9,

  /**
   10: The call frequency of the \ref agora::rtm::IRtmService::login "login"
...
enum LOGOUT_ERR_CODE {
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login"
   method, or the method call of \ref agora::rtm::IRtmService::login "login"
...
enum CONNECTION_STATE {
  ...
  /**
   ...
   When the user calls the \ref agora::rtm::IRtmService::login "login" method,
   the SDK starts to log in the Agora RTM system, triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback, and switches to the \ref
   agora::rtm::CONNECTION_STATE_CONNECTING "CONNECTION_STATE_CONNECTING" state.
   */
  ...
  /**
   ...
   agora::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess"
   callback, the SDK triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   ...
   agora::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure"
   callback, the SDK triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   agora::rtm::CONNECTION_STATE_DISCONNECTED "CONNECTION_STATE_DISCONNECTED"
   state.
   */
  ...
  /**
   ...
   - If the connection state between the SDK and the Agora RTM system is
   ...
   logs in the Agora RTM system with the same user ID, the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback is triggered, and the SDK is switched to
   the \ref agora::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED"
   state.
   - If the user calls the \ref agora::rtm::IRtmService::logout "logout" method
   to log out of the Agora RTM system and receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLogout "onLogout" callback (error code
  ...
  /**
   4: The connection state between the SDK and the Agora RTM system is
   interrupted due to network issues, and the SDK keeps re-logging in the Agora
   RTM system.

   - If the SDK successfully re-logs in the Agora RTM system, the SDK triggers
   the \ref agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged
   "onConnectionStateChanged" callback and switches to the \ref
   agora::rtm::CONNECTION_STATE_CONNECTED "CONNECTION_STATE_CONNECTED" state.
   The SDK automatically adds the user back to the channels he or she was in
   when the connection was interrupted, and synchronizes the local user's
  ...
  /**
   ...
   You must call the \ref agora::rtm::IRtmService::logout "logout" method to
   leave this state before calling the \ref agora::rtm::IRtmService::login
   "login" method again.
   */
...
enum CONNECTION_CHANGE_REASON {
  ...
  /**
   4: The SDK fails to log in the Agora RTM system within six seconds and gives
   up.
   */
  CONNECTION_CHANGE_REASON_LOGIN_TIMEOUT = 4,

  /**
   5: The connection between the SDK and the Agora RTM system is interrupted.
   The system defines an interruption when the SDK loses connection with the
   Agora RTM system for network reasons and cannot recover in four seconds.
   */
  CONNECTION_CHANGE_REASON_INTERRUPTED = 5,

  /**
   6: The user has called the \ref agora::rtm::IRtmService::logout "logout"
...
enum PEER_MESSAGE_ERR_CODE {
  ...
  /**
   ...
   agora::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   agora::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   5: The method call frequency exceeds the limit of (RTM SDK for Windows C++)
   180 calls every three seconds or (RTM SDK for Linux C++) 1500 calls every
   three seconds, with channel and peer messages taken together..
   */
  ...
  /**
   102: The sender does not call the \ref agora::rtm::IRtmService::login "login"
   method, or the method call of \ref agora::rtm::IRtmService::login "login"
...
enum JOIN_CHANNEL_ERR {
  ...
  /**
   2: For v1.0.0 and earlier, the SDK returns this error when you try to join a
   channel that you have already joined. The SDK does not return this error code
   after v1.0.0.
   */
...
enum LEAVE_CHANNEL_ERR {
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login"
   method, or the method call of \ref agora::rtm::IRtmService::login "login"
   does not succeed before calling the \ref agora::rtm::IChannel::leave "leave"
   method.
   */
...
enum CHANNEL_MESSAGE_ERR_CODE {
  ...
  /**
   ...
   \ref agora::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" or \ref
   agora::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING"
   state.
   */
  ...
  /**
   3: The method call frequency exceeds the limit of (RTM SDK for Windows C++)
   180 calls every three seconds or (RTM SDK for Linux C++) 1500 calls every
   three seconds, with channel and peer messages taken together..
   */
...
enum QUERY_PEERS_ONLINE_STATUS_ERR {
  ...
  /**
   5: The method call frequency exceeds the limit of (RTM SDK for Windows C++)
   10 calls every five seconds or (RTM SDK for Linux C++) 100 calls every five
   seconds.
   */
...
/**
 @brief Error codes related to getting a list of the peers by subscription
 option type.
 */
enum QUERY_PEERS_BY_SUBSCRIPTION_OPTION_ERR {
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login"
   method, or the method call of \ref agora::rtm::IRtmService::login "login"
   does not succeed before the query.
   */
...
enum ATTRIBUTE_OPERATION_ERR {
  ...
  /**
   ...
   taken together: the maximum call frequency is (RTM SDK for Windows C++) 10
   calls every five seconds or (RTM SDK for Linux C++) 100 calls every five
   seconds.
   - For \ref agora::rtm::IRtmService::getUserAttributes "getUserAttributes" and
   \ref agora::rtm::IRtmService::getUserAttributesByKeys
   "getUserAttributesByKeys" taken together, the maximum call frequency is (RTM
   SDK for Windows C++) 40 calls every five seconds or (RTM SDK for Linux C++)
   400 calls every five seconds.
   - For \ref agora::rtm::IRtmService::setChannelAttributes
   ...
   calls every five seconds or (RTM SDK for Linux C++) 100 calls every five
   seconds.
   - For \ref agora::rtm::IRtmService::getChannelAttributes
   "getChannelAttributes" and \ref
   agora::rtm::IRtmService::getChannelAttributesByKeys
   "getChannelAttributesByKeys" taken together, the maximum call frequency is
   (RTM SDK for Windows C++) 10 calls every five seconds or (RTM SDK for Linux
   C++) 400 calls every five seconds.
   */
...
enum DOWNLOAD_MEDIA_ERR_CODE {
  ...
  /**
   ...
   - The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
...
enum UPLOAD_MEDIA_ERR_CODE {
  ...
  /**
   1: Unknown common failure. Please check whether the file exists and whether
  ...
  /**
   ...
   - The user in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
...
class IMessage {
 ...
 public:
  ...
  /**
   ...
   agora::rtm::SendMessageOptions::enableOfflineMessaging
  ...
  /**
   ...
   agora::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived" or
   the \ref agora::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer
...
class IImageMessage : public IMessage {
 public:
  ...
  /**
   ...
   agora::rtm::IImageMessage::setWidth() "setWidth" overrides the width
   calculated by the SDK.
  ...
  /**
   ...
   - If the uploaded image is in JPG, JPEG, BMP, or PNG format, the SDK
   automatically calculates the width and height of the image. You can call \ref
   agora::rtm::IImageMessage::getHeight() "getHeight" directly to get the height
   of the image.
...
struct PeerOnlineStatus {
  ...
  /**
   ...
   agora::rtm::PeerOnlineStatus::onlineState "onlineState" instead.
   ...
   - false: The user is offline (the user has logged out of the Agora RTM
   system, has not logged in, or has failed to logged in).
   */
  bool isOnline;
  ...
  /**
   ...
   the online status of specified peers (\ref
   ...
   agora::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged
...
class IChannelEventHandler {
 public:
  ...
  /**
   ...
   When the local user calls the \ref agora::rtm::IChannel::join "join" method
   ...
   */
  virtual void onGetMembers(IChannelMember **members, int userCount,
  ...
  /**
   ...
   when the number changes at the frequency of once per second.
   - When the number of channel members exceeds 512, the SDK returns this
   callback when the number changes at the frequency of once every three
   seconds.
   - You will receive this callback when successfully joining an RTM channel, so
   Agora recommends implementing this callback to receive timely updates on the
...
class IChannel {
 ...
 public:
  ...
  /**
   ...
   agora::rtm::IChannelEventHandler::onJoinFailure "onJoinFailure" callback. See
  ...
  */
  ...
  /**
   ...
   - If this method call succeeds:
      - The local user receives the \ref
   agora::rtm::IChannelEventHandler::onLeave "onLeave" callback with the
   LEAVE_CHANNEL_ERR_OK state.
      - All remote users receive the \ref
   agora::rtm::IChannelEventHandler::onMemberLeft "onMemberLeft" callback.
   - If this method call fails, the local user receives the \ref
   agora::rtm::IChannelEventHandler::onLeave "onLeave" callback with an error
   code. See \ref agora::rtm::LEAVE_CHANNEL_ERR "LEAVE_CHANNEL_ERR" for the
   error codes.
   @return
   - 0: Success.
  ...
  /**
   ...
   Agora does not recommend using this method to send a channel message. Use
   \ref agora::rtm::IChannel::sendMessage(const IMessage *message, const
   SendMessageOptions &options) "sendMessage" instead.

   If this method call succeeds:
   - The \ref agora::rtm::IChannelEventHandler::onSendMessageResult
   "onSendMessageResult" callback returns the result.
   - All remote users in the channel receive the \ref
   agora::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived"
   callback.
   

   @note You can send messages, including peer-to-peer and channel messages, at
   a maximum frequency of (RTM SDK for Windows C++) 180 calls every three
   seconds or (RTM SDK for Linux C++) 1500 calls every three seconds.

   @param message The message to be sent. See \ref agora::rtm::IMessage
   "IMessage".
   @return
   - 0: Success.
  ...
  /**
   ...
   The \ref agora::rtm::IChannelEventHandler::onGetMembers "onGetMembers"
   callback returns the result of this method call.
   

   @note You can call this method at a maximum frequency of five calls every two
   seconds. This method returns a maximum of 512 members. If the number of
   channel members exceed 512, the method returns 512 members randomly.
  ...
  /**
   Releases all resources used by the \ref agora::rtm::IChannel "IChannel"
   instance.
   */
  virtual void release() = 0;
};
...
class IRtmServiceEventHandler {
 ...
 agora::rtm::IFileMessage "IFileMessage".
  ...
  virtual void onMediaUploadingProgress(
      long long requestId, const MediaOperationProgress &progress) {
    (long long)requestId;
 ...
 "cancelMediaUpload" method call.
  ...
  virtual void onQueryPeersOnlineStatusResult(
      long long requestId, const PeerOnlineStatus *peersStatus, int peerCount,
  ...
  virtual void onSubscriptionRequestResult(
      long long requestId, PEER_SUBSCRIPTION_STATUS_ERR errorCode) {
    (long long)requestId;
  ...
  /**
   ...
   - When the subscription to the online status of specified peers succeeds, the
  ...
  virtual void onSetLocalUserAttributesResult(
      long long requestId, ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
  ...
  virtual void onGetChannelAttributesResult(
      long long requestId, const IRtmChannelAttribute *attributes[],
      int numberOfAttributes, ATTRIBUTE_OPERATION_ERR errorCode) {
    //         (long long) requestId;
    //         (const IRtmChannelAttribute**) attributes;
    //         (int) numberOfAttributes;
    //         (ATTRIBUTE_OPERATION_ERR) errorCode;
  ...
  virtual void onGetChannelMemberCountResult(
      long long requestId, const ChannelMemberCount *channelMemberCounts,
      int channelCount, GET_CHANNEL_MEMBER_COUNT_ERR_CODE errorCode) {
    (long long)requestId;
...
class IRtmService {
 ...
 public:
  /**
   ...
   @param appId The App ID issued by Agora to you. Apply for a new App ID from
   Agora if it is missing from your kit.
   @param eventHandler An IRtmServiceEventHandler object that invokes callbacks
   to be passed to the application on Agora RTM SDK runtime events.
   @return
   - 0: Success.
   - < 0: Failure.
   */
  ...
  /**
   Releases all resources used by the \ref agora::rtm::IRtmService "IRtmService"
   instance.
   */
  ...
  /**
   ...
   - If this method call fails, the local user receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure"
   callback. See \ref agora::rtm::LOGIN_ERR_CODE "LOGIN_ERR_CODE" for the error
   codes.
   ...
   the \ref agora::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess"
   callback), can you call the key RTM methods except:
        ...
        - \ref agora::rtm::IRtmCallManager::createLocalCallInvitation
   "createLocalCallInvitation"
        - \ref agora::rtm::IRtmService::createChannelAttribute
   "createChannelAttribute"

   @param token Token used to log in the Agora RTM system and used when dynamic
   authentication is enabled. Set @p token as @p nil in the integration and test
   stages.
   @param userId The user ID of the user logging in Agora's RTM system. The
  ...
  /**
   ...
   The local user receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLogout "onLogout" callback. See \ref
   agora::rtm::LOGOUT_ERR_CODE "LOGIN_ERR_CODE" for the error codes.
  ...
  /**
   ...
   agora::rtm::IRtmServiceEventHandler::onTokenExpired "onTokenExpired"
   callback, and the \ref
   agora::rtm::IRtmServiceEventHandler::onRenewTokenResult "onRenewTokenResult"
   callback returns the result of this method call. The call frequency limit for
   this method is 2 queries per second.
  ...
  /**
   ...
   \ref agora::rtm::IRtmService::sendMessageToPeer(const char *peerId, const
   ...
   maximum frequency of (RTM SDK for Windows C++) 180 calls every three seconds
   or (RTM SDK for Linux C++) 1500 calls every three seconds.

   @param peerId User ID of the receiver.
   @param message The message to be sent. For information about creating a
   message, see \ref agora::rtm::IMessage "IMessage".
   @return
   - 0: Success.
  ...
  /**
   Downloads a file or image from the Agora server to the local memory by media
   ID.

   The SDK returns the result of this method call by the \ref
   agora::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   ...
   the \ref agora::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult
   "onMediaDownloadToMemoryResult" callback.
  ...
  /**
   Downloads a file or image from the Agora server to a specified local
   directory by media ID.
  ...
  /**
   ...
   agora::rtm::IRtmServiceEventHandler::onMediaCancelResult
   "onMediaCancelResult" callback.
...
offline when you send it, the RTM server caches it. Please note that for now we
only cache 200 offline messages for up to seven days for each receiver. When the
number of the cached messages reaches this limit, the newest message overrides
the oldest one.
   

   If you use this method to send off a <i>text</i> message that starts off with
AGORA_RTM_ENDCALL_PREFIX_\<channelId\>_\<your additional information\>, then
this method is compatible with the endCall method of the legacy Agora Signaling
SDK. Replace \<channelId\> with the channel ID from which you want to leave (end
call), and replace \<your additional information\> with any additional
information. Note that you must not put any "_" (underscore" in your additional
information but you can set \<your additional information\> as empty "".
   

   - The \ref agora::rtm::IRtmServiceEventHandler::onSendMessageResult
...
information but you can set \<your additional information\> as empty "".
   ...
   @note You can send messages, including peer-to-peer and channel messages, at
a maximum frequency of (RTM SDK for Windows C++) 180 calls every three seconds
or (RTM SDK for Linux C++) 1500 calls every three seconds.
...
agora::rtm::SendMessageOptions "SendMessageOptions".
  ...
  /**
   ...
   Agora recommends calling the \ref agora::rtm::IChannel::release "release"
   ...
   @return
   - An \ref agora::rtm::IChannel "IChannel" object: Success. If a channel with
   the same @p channelId does not exist, the method returns the created channel
   instance. If a channel with the same @p channelId already exists, the method
   returns the existing channel instance.
   - null: Failure. Possible reasons: The @p channelId is invalid or you have
  ...
  /**
   ...
   Each \ref agora::rtm::IRtmService "IRtmService" object corresponds to a
 unique \ref agora::rtm::IRtmCallManager "IRtmCallManager" object. That said,
 the \ref agora::rtm::IRtmCallManager "IRtmCallManager" object is \ref
 agora::rtm::IRtmService "IRtmService"-specific.
 

   @note When you do no use \ref agora::rtm::IRtmCallManager "IRtmCallManager",
 call the \ref agora::rtm::IRtmCallManager::release "release" method to release
 all of its resources.
 

   @param eventHandler An \ref agora::rtm::IRtmCallEventHandler
 "IRtmCallEventHandler" object.
  ...
  /**
   ...
   @note
   - An \ref agora::rtm::IMessage "IMessage" instance can be used either for a
   channel message or for a peer-to-peer message.
   - When you no longer need an \ref agora::rtm::IMessage "IMessage" instance,
   please call the \ref agora::rtm::IMessage::release "release" method to
   release all resources that it is using.
   - You can set the content of the text message at a later point using the \ref
   agora::rtm::IMessage::setText "setText" method, but please ensure that the
 ...
 channel message or for a peer-to-peer message.
   - When you no longer need an \ref agora::rtm::IMessage "IMessage" instance,
 please call the \ref agora::rtm::IMessage::release "release" method to release
 ...
 using the \ref agora::rtm::IMessage::setText "setText" method, but please
 ...
 exceed 32 KB.
  ...
  /**
   Creates a raw \ref agora::rtm::IMessage "IMessage" instance and sets its
 description.
 ...
 raw message at a later point using the \ref agora::rtm::IMessage::setText
 ...
 combined does not exceed 32 KB.
   ...
   @return A raw \ref agora::rtm::IMessage "IMessage" instance with a brief text
 description.
   */
  ...
  /**
   ...
   - If you have at hand the media ID of a file on the Agora server, you can
 call this method to create an \ref agora::rtm::IFileMessage "IFileMessage"
 instance.
   - If you do not have a media ID, then you must call \ref
 agora::rtm::IRtmService::createFileMessageByUploading
 "createFileMessageByUploading" to get a corresponding \ref
 agora::rtm::IFileMessage "IFileMessage" instance by uploading a file to the
 Agora RTM server.
  ...
  /**
   Creates an \ref agora::rtm::IImageMessage "IImageMessage" instance by media
   ID.
   

   - If you have at hand the media ID of an image on the Agora server, you can
   call this method to create an \ref agora::rtm::IImageMessage "IImageMessage"
   instance.
   - If you do not have a media ID, then you must call \ref
   agora::rtm::IRtmService::createImageMessageByUploading
   "createImageMessageByUploading" to get a corresponding \ref
   agora::rtm::IImageMessage "IImageMessage" instance by uploading an image to
  ...
  /**
   Gets an \ref agora::rtm::IFileMessage "IFileMessage" instance by uploading a
 file to the Agora server.
   

   The SDK returns the result with the \ref
 agora::rtm::IRtmServiceEventHandler::onFileMediaUploadResult callback. If
 success, this callback returns a corresponding \ref agora::rtm::IFileMessage
 "IFileMessage" instance.
   

   @note
   - If you have at hand the media ID of a file on the Agora server, you can
 call \ref agora::rtm::IRtmService::createFileMessageByMediaId
 "createFileMessageByMediaId" to create an \ref agora::rtm::IFileMessage
 "IFileMessage" instance.
   - To cancel an ongoing file upload task, call \ref
 agora::rtm::IRtmService::cancelMediaUpload "cancelMediaUpload".
  ...
  /**
   Gets an \ref agora::rtm::IImageMessage "IImageMessage" instance by uploading
 an image to the Agora server.
 

   The SDK returns the result by the \ref
 agora::rtm::IRtmServiceEventHandler::onImageMediaUploadResult callback. If
 success, this callback returns a corresponding \ref agora::rtm::IImageMessage
 ...
 agora::rtm::IImageMessage::getWidth "getWidth" and \ref
 agora::rtm::IImageMessage::getHeight "getHeight" to get the calculated width
 and height.
   - Otherwise, you need to call \ref agora::rtm::IImageMessage::setWidth
 "setWidth" and \ref agora::rtm::IImageMessage::setHeight "setHeight" to set the
 width and height of the uploaded image by yourself.

   @note
   - If you have at hand the media ID of an image on the Agora server, you can
 call \ref agora::rtm::IRtmService::createImageMessageByMediaId
 "createImageMessageByMediaId" to create an \ref agora::rtm::IImageMessage
 ...
 agora::rtm::IRtmService::cancelMediaUpload "cancelMediaUpload".
  ...
  /**
   Creates an \ref agora::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
 instance.
 

   @return An \ref agora::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
 instance.
   */
  ...
  /**
   ...
   @note The JSON options are not public by default. Agora is working on making
   commonly used JSON options public in a standard way. Contact
   [support@agora.io](mailto:support@agora.io) for more information.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onSubscriptionRequestResult
   ...
   @note
   - When you log out of the Agora RTM system, all the status that you subscribe
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onGetUserAttributesResult
   "onGetUserAttributesResult" callback.
   

   @note For \ref agora::rtm::IRtmService::getUserAttributes "getUserAttributes"
   and \ref agora::rtm::IRtmService::getUserAttributesByKeys
   "getUserAttributesByKeys" taken together, the maximum call frequency is (RTM
   SDK for Windows C++) 40 calls every five seconds or (RTM SDK for Linux C++)
   400 calls every five seconds.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onSetChannelAttributesResult
   ...
   - If more than one user can update the channel attributes, then Agora
   recommends calling \ref agora::rtm::IRtmService::getChannelAttributes
   ...
   agora::rtm::IRtmChannelAttribute "IRtmChannelAttribute".
   @param numberOfAttributes The total number of the channel attributes.
  ...
  virtual int addOrUpdateChannelAttributes(
      const char *channelId, const IRtmChannelAttribute *attributes[],
  ...
  virtual int deleteChannelAttributesByKeys(
      const char *channelId, const char *attributeKeys[], int numberOfKeys,
      const ChannelAttributeOptions &options, long long &requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onGetChannelAttributesResult
  ...
  /**
   ...
   agora::rtm::IRtmService "IRtmService" instance, otherwise the output log may
   be incomplete.
   - For the Linux C++ platform, <i>agorartm.log</i> is in the current working
   directory.
  ...
  /**
   ...
   @param fileSizeInKBytes The size of a single log file (KB). The default is
   `10240` (KB). The value range is [512 KB, 1 GB].
   @return
   - 0: Success.
   - &ne;0: Failure.
   */
...
@note When you no longer need an \ref agora::rtm::IRtmService "IRtmService"
instance, ensure that you call the \ref agora::rtm::IRtmService::release
...
/**
 Region for the Agora RTM service. After setting a region, the RTM SDK can only
 connect to the Agora RTM service in the specified region.
 */
enum RTM_AREA_CODE {
  /**
   * Mainland China.
...
/**
 Error codes returned by \ref agora::rtm::setRtmServiceContext
 "setRtmServiceContext". See #RTM_AREA_CODE.
 */
enum SET_RTM_SERVICE_CONTEXT_ERR_CODE {
  ...
  /**
   1: Failed to configure the context for the Agora RTM service because at least
   one \ref agora::rtm::IRtmService "IRtmService" instance already exists. Call
   \ref agora::rtm::IRtmService::release "release" to destroy any existing
   `%IRtmService` instance before configuring the context for the Agora RTM
   service.
   */
...
/**
 Sets the context of all `IRtmService` instances. All `%IRtmservice` instances
 you create after calling this method match the context.

 @note You must call this method before calling #createRtmService to create an
 `%IRtmservice` instance or after destroying any existing `%IRtmservice`
 instance. Otherwise, this method returns the
 #SET_RTM_SERVICE_CONTEXT_ERR_FAILURE error code.

 @param context Context of the `%IRtmservice` instance, including geofencing.
 See \ref agora::rtm::RtmServiceContext "RtmServiceContext".
