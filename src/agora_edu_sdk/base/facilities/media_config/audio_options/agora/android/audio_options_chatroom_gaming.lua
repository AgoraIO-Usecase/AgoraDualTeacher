...
if mc_valid(options.has_subscribed_stream) and mc_value(options.has_subscribed_stream) and
   mc_valid(options.has_published_stream) and mc_value(options.has_published_stream) and
   mc_valid(options.apm_enable_ns) and mc_value(options.apm_enable_ns) then
  options.apm_enable_tone_remover = true
else
  options.apm_enable_tone_remover = false
end
