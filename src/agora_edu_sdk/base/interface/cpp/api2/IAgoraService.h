...
class IAgoraService {
 public:
   ...
   * Android.
   *   - `ERR_INIT_NET_ENGINE`, if the net engine cannot be initialized. On Windows, the error occurs mostly because the connection to the local port is disabled by the firewall. In this case, turn off the firewall and then turn it on again.
   */
