...
enum RECV_TYPE : uint8_t {
  /**
   * Process the packet by Agora media pipeline and don't deliver it to user registered receiver.
   */
  RECV_MEDIA_ONLY = 0,
  /**
   * Won't process the packet by Agora media pipeline, but only deliver it to user registered receiver.
   */
  RECV_PACKET_ONLY,
  /**
   * Process the packet by Agora media pipeline and deliver it to user registered receiver.
   */
