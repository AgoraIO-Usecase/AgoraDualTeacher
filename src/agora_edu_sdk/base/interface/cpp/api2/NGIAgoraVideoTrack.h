...
class IVideoTrack : public RefCountInterface {
 public:
   ...
   */
  virtual bool addVideoFilter(agora_refptr<IVideoFilter> filter, media::base::VIDEO_MODULE_POSITION position = media::base::POSITION_POST_CAPTURER) = 0;
  /**
   ...
   */
  virtual bool removeVideoFilter(agora_refptr<IVideoFilter> filter, media::base::VIDEO_MODULE_POSITION position = media::base::POSITION_POST_CAPTURER) = 0;
   ...
   * @param position The position where the renderer is removed: #VIDEO_MODULE_POSITION.
   * @return
