...
#define SET_FROM(X) SetFrom(&X, change.X)
    ...
    SET_FROM(av_enc_common_format_constraint);
    ...
    SET_FROM(av_enc_mpv_quant_matrix_chroma_intra);
    SET_FROM(av_enc_mpv_quant_matrix_chroma_non_intra);
    SET_FROM(av_enc_mpv_quant_matrix_intra);
    SET_FROM(av_enc_mpv_quant_matrix_non_intra);
...
#define END_COMPARE()
    ...
    ADD_COMPARE(av_enc_common_format_constraint);
    ...
    ADD_COMPARE(av_enc_mpv_quant_matrix_chroma_intra);
    ADD_COMPARE(av_enc_mpv_quant_matrix_chroma_non_intra);
    ADD_COMPARE(av_enc_mpv_quant_matrix_intra);
    ADD_COMPARE(av_enc_mpv_quant_matrix_non_intra);
...
#define ADD_STRING(X) ost << ToStringIfSet(#X, X)
    ...
    ADD_STRING(av_enc_common_format_constraint);
    ...
    ADD_STRING(av_enc_mpv_quant_matrix_chroma_intra);
    ADD_STRING(av_enc_mpv_quant_matrix_chroma_non_intra);
    ADD_STRING(av_enc_mpv_quant_matrix_intra);
    ADD_STRING(av_enc_mpv_quant_matrix_non_intra);
...
#undef ADD_STRING
  ...
  absl::optional<int> codec_type;
  absl::optional<int> frame_width;
  absl::optional<int> frame_height;
  absl::optional<int> frame_rate;
  absl::optional<int> start_bitrate;
  absl::optional<int> target_bitrate;
  absl::optional<int> min_bitrate;
  absl::optional<int> max_bitrate;
  absl::optional<int> orientation_mode;
  absl::optional<uint8_t> number_of_temporal_layers;
  absl::optional<std::string> sps_data;
  absl::optional<std::string> pps_data;
  absl::optional<int> h264_profile;
  absl::optional<bool> adaptive_op_mode;
  absl::optional<uint8_t> number_of_spatial_layers;
  absl::optional<bool> flexible_mode;
  absl::optional<int> interlayer_pred;
  absl::optional<int> num_of_encoder_cores;
  absl::optional<int> degradation_preference;
  absl::optional<int> complexity;
  absl::optional<bool> denoising_on;
  absl::optional<bool> automatic_resize_on;
  absl::optional<bool> frame_dropping_on;
  absl::optional<int> key_frame_interval;
  absl::optional<int> entropy_coding_mode_flag;
  absl::optional<int> loop_filter_disable_idc;
  absl::optional<bool> background_detection_on;
  absl::optional<int> posted_frames_waiting_for_encode;

  // followings are hw setting

  // Specifies whether or not to enable hw encode.
  absl::optional<bool> enable_hw_encoder;
  // Specifies whether or not to enable hw decode.
  absl::optional<bool> enable_hw_decoder;
  // Specifies the current input format for the decoder.
  absl::optional<std::string> av_dec_common_input_format;
  // Specifies the output format for the decoder.
  absl::optional<std::string> av_dec_common_output_format;
  // Specifies the Multimedia Class Scheduler Service (MMCSS) class for the decoding thread.
  absl::optional<std::string> av_dec_mmcss_class;

  // Specifies the encoding scheme.
  absl::optional<std::string> av_enc_codec_type;
  // Specifies the initial level of the encoding buffer.
  absl::optional<uint32_t> av_enc_common_buffer_in_level;
  // Specifies the final level of the encoding buffer at the end of the encoding process.
  absl::optional<uint32_t> av_enc_common_buffer_out_level;
  // Specifies the size of the buffer used during encoding.
  absl::optional<uint32_t> av_enc_common_buffer_size;
  // Specifies the target format for an encoder.
  absl::optional<std::string> av_enc_common_format_constraint;
  // Specifies whether the output stream should be structured so that the encoded stream has a
  // low decoding latency.
  absl::optional<bool> av_enc_common_low_latency;
  // Specifies the maximum bit rate.
  absl::optional<int> av_enc_common_max_bit_rate;
  // Specifies the average bit rate.
  absl::optional<int> av_enc_common_mean_bit_rate;
  // Specifies the time interval over which the average bit rate applies.
  absl::optional<int> av_enc_common_mean_bit_rate_interval;
  // Specifies the minimum bit rate.
  absl::optional<int> av_enc_common_min_bit_rate;
  // Specifies the quality level for encoding.
  //    0	  Minimum quality, smaller output size.
  //    100	Maximum quality, larger output size.
  absl::optional<uint32_t> av_enc_common_quality;
  ...
  absl::optional<uint32_t> av_enc_common_quality_vs_speed;
  ...
  absl::optional<uint32_t> av_dec_video_input_scan_type;
  ...
  absl::optional<uint32_t> av_dec_video_pixel_aspect_ratio;
  ...
  absl::optional<uint32_t> av_dec_video_software_deinterlace_mode;
  // Specifies the power-saving level.
  //   0	Optimize for battery life.
  // 100	Optimize for video quality.
  absl::optional<uint32_t> av_dec_video_sw_power_level;
  // Enables or disables thumbnail generation mode.
  absl::optional<bool> av_dec_video_thumbnail_generation_mode;
  ...
  absl::optional<uint32_t> av_enc_input_video_system;
  // Specifies the tradeoff between motion and still images.
  // 0	Optimize for still images
  // 100	Optimize for motion.
  absl::optional<uint32_t> av_enc_video_cbr_motion_tradeoff;
  // Specifies the size of the video access units.
  absl::optional<uint32_t> av_enc_video_coded_video_access_unit_size;
  // Specifies which field is displayed first.
  absl::optional<bool> av_enc_video_default_upper_field_dominant;
  ...
  // height, in pixels.
  absl::optional<uint32_t> av_enc_video_display_dimension;
  // Specifies the width and height of the encoded video, if the video is cropped.
  // The upper 16 bits of the value contain the width, in pixels. The lower 16 bits contain the
  // height, in pixels.
  absl::optional<uint32_t> av_enc_video_encode_dimension;
  ...
  absl::optional<uint32_t> av_enc_video_encode_offset_origin;
  // Reverses the order of the interlaced fields in the source video.
  absl::optional<bool> av_enc_video_field_swap;
  ...
  absl::optional<uint32_t> av_enc_video_input_chroma_resolution;
  // Specifies the chroma siting for the input video.
  absl::optional<uint32_t> av_enc_video_input_chroma_subsampling;
  ...
  absl::optional<uint32_t> av_enc_video_input_color_lighting;
  ...
  absl::optional<uint32_t> av_enc_video_input_color_nominal_range;
  ...
  absl::optional<uint32_t> av_enc_video_input_color_primaries;
  ...
  absl::optional<uint32_t> av_enc_video_input_color_transfer_function;
  ...
  absl::optional<uint64_t> av_enc_video_no_of_fields_to_skip;
  ...
  //    eAVEncVideoChromaResolution_420,
  //    eAVEncVideoChromaResolution_411
  absl::optional<uint32_t> av_enc_video_output_chroma_resolution;
  ...
  absl::optional<uint32_t> av_enc_video_output_chroma_subsampling;
  ...
  //    eAVEncVideoColorLighting_Dim,
  //    eAVEncVideoColorLighting_Dark
  absl::optional<uint32_t> av_enc_video_output_color_lighting;
  // Specifies the nominal range for the encoded video.
  //    eAVEncVideoColorNominalRange_SameAsSource,
  //    eAVEncVideoColorNominalRange_0_255,
  //    eAVEncVideoColorNominalRange_16_235,
  //    eAVEncVideoColorNominalRange_48_208
  absl::optional<uint32_t> av_enc_video_output_color_nominal_range;
  ...
  //    eAVEncVideoColorPrimaries_EBU3231,
  //    eAVEncVideoColorPrimaries_SMPTE_C
  absl::optional<uint32_t> av_enc_video_output_color_primaries;
  ...
  //    eAVEncVideoColorTransferFunction_22_8bit_sRGB,
  //    eAVEncVideoColorTransferFunction_28
  absl::optional<uint32_t> av_enc_video_output_color_transfer_function;
  // Specifies the conversion matrix from the YCbCr color space to the RGB color space, for the
  // encoded video.
  //    eAVEncVideoColorTransferMatrix_SameAsSource,
  //    eAVEncVideoColorTransferMatrix_BT709,
  //    eAVEncVideoColorTransferMatrix_BT601,
  //    eAVEncVideoColorTransferMatrix_SMPTE240M
  absl::optional<uint32_t> av_enc_video_output_color_transfer_matrix;
  ...
  // 59.94	        60000/1001
  // 60	            60/1
  absl::optional<uint64_t> av_enc_video_output_frame_rate;
  ...
  absl::optional<uint32_t> av_enc_video_output_frame_rate_conversion;
  ...
  absl::optional<uint32_t> av_enc_video_output_scan_type;
  // Specifies the pixel aspect ratio.
  // The upper 16 bits of the value contain the width, and the lower 16 bits contain the height.
  absl::optional<uint32_t> av_enc_video_pixel_aspect_ratio;
  ...
  absl::optional<uint32_t> av_enc_mpv_intra_vlc_table;
  // Specifies the MPEG-2 level.
  //    eAVEncMPVLevel_Low,
  //    eAVEncMPVLevel_Main,
  //    eAVEncMPVLevel_High1440,
  //    eAVEncMPVLevel_High
  absl::optional<uint32_t> av_enc_mpv_level;
  ...
  absl::optional<uint32_t> av_enc_mpv_profile;
  ...
  absl::optional<uint32_t> av_enc_mpvq_scale_type;
  // Specifies the chroma quantization matrix for intra macroblocks.
  absl::optional<std::string> av_enc_mpv_quant_matrix_chroma_intra;
  // Specifies the chroma quantization matrix for non-intra macroblocks.
  absl::optional<std::string> av_enc_mpv_quant_matrix_chroma_non_intra;
  // Specifies the luma quantization matrix for intra macroblocks.
  absl::optional<std::string> av_enc_mpv_quant_matrix_intra;
  // Specifies the luma quantization matrix for non-intra macroblocks.
  absl::optional<std::string> av_enc_mpv_quant_matrix_non_intra;
  ...
  absl::optional<uint32_t> av_enc_mpv_scan_pattern;
  ...
  absl::optional<uint32_t> av_enc_mpv_scene_detection;
  // Specifies whether the encoder uses concealment motion vectors.
  absl::optional<bool> av_enc_mpv_use_concealment_motion_vectors;
  absl::optional<bool> vdm_not_override_lua_smallvideo_not_use_hwenc_policy;

 private:
  template <class T>
  std::string ToStringIfSet(const char* key, const absl::optional<T>& val) const {
    std::string str;
    if (val) {
      str = key;
      str = "\t\"" + str + "\"";
  ...
  std::string ToStringIfSet(const char* key, const absl::optional<std::string>& val) const {
    std::string str;
    if (val) {
      str = key;
      str = "\t\"" + str + "\"";
  ...
  std::string ToStringIfSet(const char* key, const absl::optional<bool>& val) const {
    std::string str;
    if (val) {
      str = key;
      str = "\t\"" + str + "\"";
