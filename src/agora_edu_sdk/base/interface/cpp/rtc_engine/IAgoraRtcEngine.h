...
class IRtcEngineEventHandler {
  ...
  */
   ...
   * - A remote user or broadcaster joins the channel by calling `joinChannel`.
...
public:
    ...
    */
    ...
    /** Notification for starting sending the metadata.
     *
     * The SDK triggers this callback to remind you to start sending the metadata.
     * After receiving this callback, you can do some preparation and then use the
     * value return to tell the SDK whether your metadata is ready to be sent.
     *
     * @note Ensure that your metadata size does not exceed the size set in the
     * return value of \ref agora::rtc::IMetadataObserver::getMaxMetadataSize "getMaxMetadataSize".
     *
     * @param metadata The metadata to be sent. See Metadata.
     *
     * @note Ignore `uid` in the Metadata struct.
     *
     * @return
     * - true: The metadata is ready to be sent.
     * - false: The metadata is not ready to be sent.
     */
...
///@endcond
  ...
  */
   ...
   *
   * @param renderMode Sets the local display mode. See \ref agora::media::base::RENDER_MODE_TYPE "RENDER_MODE_TYPE".
   *
   * @return
   * - 0: Success.
   * - < 0: Failure.
