...
static inline void rtc_AsanPoison(const volatile void* ptr, size_t element_size,
                                  size_t num_elements) {
#if RTC_HAS_ASAN
...
static inline void rtc_AsanUnpoison(const volatile void* ptr, size_t element_size,
                                    size_t num_elements) {
#if RTC_HAS_ASAN
...
static inline void rtc_MsanMarkUninitialized(const volatile void* ptr, size_t element_size,
                                             size_t num_elements) {
#if RTC_HAS_MSAN
...
// MSan report).
static inline void rtc_MsanCheckInitialized(const volatile void* ptr, size_t element_size,
                                            size_t num_elements) {
#if RTC_HAS_MSAN
...
constexpr bool IsTriviallyCopyable() {
  return static_cast<bool>(
      ...
      (absl::is_trivially_copy_assignable<T>::value || !std::is_copy_assignable<T>::value) &&
