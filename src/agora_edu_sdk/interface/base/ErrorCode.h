...
enum ERROR_CODE_TYPE {
   ...
   */
  ERR_NOT_SUPPORTED = 4,
  /** 5: The request is rejected. This is for internal SDK use only, and it does
  ...
  /** 9: No permission exists. This is for internal SDK use only, and it does
   * not return to the application through any method or callback.
   */
  ERR_NO_PERMISSION = 9,
   ...
   * the channel, for example, \ref agora::rtc::IRtcEngine::joinChannel
   * "joinChannel".
   */
  ...
  /** 18: The request to leave the channel is rejected.
   ...
   agora::rtc::IRtcEngine::leaveChannel "leaveChannel" to leave the channel. In
   this case, stop calling \ref agora::rtc::IRtcEngine::leaveChannel
   "leaveChannel".
  ...
  /** **DEPRECATED** 109: Deprecated as of v2.4.1. Use
   ...
   does not access the Agora service after five minutes, this Token is no longer
   valid.
   - Call Expiration Timestamp expired: The timestamp is the exact time when a
   user can no longer use the Agora service (for example, when a user is forced
  ...
  /** **DEPRECATED** 110: Deprecated as of v2.4.1. Use
   ...
   - The App Certificate for the project is enabled in Dashboard, but the user
   is still using the App ID. Once the App Certificate is enabled, the user must
   use a token.
   - The uid is mandatory, and users must set the same uid as the one set in the
   \ref agora::rtc::IRtcEngine::joinChannel "joinChannel" method.
   */
   ...
   * agora::rtc::IRtcEngine::sendStreamMessage "sendStreamMessage" or \ref
   * agora::rtc::IRtcEngine::getUserInfoByUserAccount "getUserInfoByUserAccount"
   * method.
   */
   ...
   * agora::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" method
   ...
   * by calling the \ref agora::rtc::IRtcEngine::removePublishStreamUrl
   * "removePublishStreamUrl" and \ref
   * agora::rtc::IRtcEngine::addPublishStreamUrl "addPublishStreamUrl" methods.
   */
  ...
  /** 154: An error occurs in Agora's streaming server. Call the
